...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(
     smartparens ; disable attempts at inserting closing parens, braces etc.
     )
...
you should place your code here."
  ...
  ;;(defun custom-neotree-key-bindings ()
  ;;  "add keybindings for enter-hide and peek functions"
  ;;  (evilified-state-evilify neotree-mode neotree-custom-mode-map
  ...
  ;;  ;;  )
  ;;  )
  ;;(advice-add 'spacemacs//neotree-key-bindings :before #'custom-neotree-key-bindings)
